...
## Our main results:
- Transformer forecasting manifolds exhibit two phases of dimensionality and curvature drop or remain fixed during encoding, then increase during decoding. 
